...
export function IsoBranding({ className }) {
  return (
    <svg className={className} viewBox="0 0 280 280" width="140" height="140" aria-hidden="true" focusable="false">
      <path className="iso-b" d="M16.0 169.9 L140.0 241.5 L140.0 231.1 L16.0 159.5Z" />
      <path className="iso-b" d="M264.0 169.9 L140.0 241.5 L140.0 231.1 L264.0 159.5Z" />
      <path className="iso-b" d="M140.0 87.9 L264.0 159.5 L140.0 231.1 L16.0 159.5Z" />
      <path className="iso-l" d="M16.0 159.5 L140.0 231.1 L140.0 181.7 L16.0 110.1Z" />
      <path className="iso-r" d="M264.0 159.5 L140.0 231.1 L140.0 181.7 L264.0 110.1Z" />
...
export function IsoWebsites({ className }) {
  return (
    <svg className={className} viewBox="0 0 280 280" width="140" height="140" aria-hidden="true" focusable="false">
      ...
      <path className="iso-b" d="M115.2 62.7 L264.0 148.6 L246.6 158.6 L97.8 72.7Z" />
...
export function IsoMarketing({ className }) {
  return (
    <svg className={className} viewBox="0 0 280 280" width="140" height="140" aria-hidden="true" focusable="false">
      ...
      <path className="iso-b" d="M45.3 151.0 L45.7 147.1 L46.5 143.3 L47.6 139.7 L49.2 136.3 L51.1 133.2 L53.3 130.5 L55.8 128.2 L60.8 124.0 L63.9 121.9 L67.2 120.3 L70.6 119.3 L74.2 118.8 L77.8 119.0 L81.4 119.8 L84.8 121.1 L88.2 123.0 L91.3 125.4 L94.2 128.3 L96.7 131.6 L98.9 135.3 L100.7 139.3 L102.1 143.6 L103.1 148.0 L103.6 152.5 L103.6 157.1 L103.1 161.6 L102.2 165.9 L100.9 170.0 L99.1 173.9 L96.9 177.4 L94.4 180.5 L91.5 183.1 L88.4 185.2 L85.1 186.8 L81.7 187.8 L78.1 188.2 L74.5 188.1 L70.9 187.3 L67.5 186.0 L64.1 184.1 L58.8 180.9 L56.0 178.8 L53.5 176.3 L51.3 173.4 L49.4 170.1 L47.8 166.6 L46.5 162.9 L45.7 159.0 L45.3 155.0Z" />
...
export function IsoAutomation({ className }) {
  return (
    <svg className={className} viewBox="0 0 280 280" width="140" height="140" aria-hidden="true" focusable="false">
      ...
      <path className="iso-arc iso-arc--b" d="M94.3 83.5 L113.9 94.8" />
      ...
      <path className="iso-arc iso-arc--b" d="M166.1 124.9 L185.7 136.2" />
